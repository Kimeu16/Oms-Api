...
manager1 = Manager.create(first_name: "Anth", last_name: "Meu", title: "CEO")

staff1 = Staff.create(staff_name: "Gideon", joining_date: Date.tomorrow, reporting_to: "CEO", email: "gideon98@gmail.com", password: "password", tech_stack: "React & Rails", isStaff: true, admin_id: admin1.id, manager_id: manager1.id)
...
leave_type1 = LeaveType.create(leave_reason: "sick", days_allowed: 25, staff_id: staff1.id)
