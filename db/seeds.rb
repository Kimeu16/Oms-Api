...
task1 = Task.create(task_name: "Office System", assigned_to: "Anthony", managed_by: "Project Manager", project_name: "Oms", avatar_image: "", completed_files: "", project_id: project1.id, staff_id: staff1.id)
